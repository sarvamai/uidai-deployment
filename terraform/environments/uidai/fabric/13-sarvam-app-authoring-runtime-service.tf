locals {
  ...
  sarvam_app_authoring_runtime_service_from = {
    "observe-env" = {
      "source" = "configMapRef"
    }
    "kb-postgres-db-env" = {
  ...
  sarvam_app_authoring_runtime_service_vars = merge(
    {
...
module "sarvam_app_authoring_runtime_service" {
  source = "../../../modules/deployment"

  name            = "sarvam-app-authoring-runtime-service"
  namespace       = var.fabric_namespace
  service_account = var.fabric_service_account
  # node_selector_labels = var.node_selector_labels

  containers = [{
    "env_from"          = local.sarvam_app_authoring_runtime_service_from
    "env_vars"          = local.sarvam_app_authoring_runtime_service_vars
